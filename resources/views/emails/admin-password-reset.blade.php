                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;">
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td style="padding-left:12px; vertical-align:middle;">
                                                    ...
                                                    <span style="display:block; font-size:12px; color:#a1a1aa; margin-top:2px;">Painel administrativo</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td style="background-color:#ffffff; padding:32px 28px;">
                            <h1 style="margin:0 0 6px; font-size:22px; line-height:1.3; color:#111111;">Recuperação de senha</h1>
                            ...
                            <p style="margin:0 0 4px; font-size:12px; line-height:1.6; color:#71717a; padding-top:20px;">
                                Este link é válido por {{ $expiresInMinutes }} minutos e só pode ser usado uma vez.
                            </p>
                    ...
                    <tr>
                        <td style="background-color:#0a0a0a; border-radius:0 0 12px 12px; padding:16px 28px;">
                            <p style="margin:0; font-size:11px; line-height:1.5; color:#71717a;">
                                Enviado automaticamente pela plataforma {{ $brandName }}.
                            </p>
                        </td>
                    </tr>
                </table>
