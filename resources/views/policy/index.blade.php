...
@section('content')
    <div class="card p-6 sm:p-8">
        ...
        <div class="mb-5 space-y-2 border-b border-slate-100 pb-5 text-xs text-slate-400">
        ...
        <div class="space-y-5 text-sm leading-relaxed text-slate-600">
            <div>
                <h2 class="mb-1 text-sm font-semibold text-slate-900">1. Quais dados coletamos</h2>
                <p>
            ...
            <div>
                <h2 class="mb-1 text-sm font-semibold text-slate-900">2. Uso dos dados</h2>
                <p>
            ...
            <div>
                <h2 class="mb-1 text-sm font-semibold text-slate-900">3. Consentimento</h2>
                <p>
            ...
            <div>
                <h2 class="mb-1 text-sm font-semibold text-slate-900">4. Armazenamento e segurança</h2>
                <p>
            ...
            <div>
                <h2 class="mb-1 text-sm font-semibold text-slate-900">5. Cookies e sessão</h2>
                <p>
            ...
            <div>
                <h2 class="mb-1 text-sm font-semibold text-slate-900">6. Compartilhamento</h2>
                <p>
            ...
            <div>
                <h2 class="mb-1 text-sm font-semibold text-slate-900">7. Retenção e exclusão</h2>
                <p>
            ...
            <div>
                <h2 class="mb-1 text-sm font-semibold text-slate-900">8. Seus direitos</h2>
                <p>
