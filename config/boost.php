...
return [
    ...
    */
    ...
    |
    | Desabilitado no VCA: o watcher injeta um <script> inline em toda
    | resposta HTML (browser-logger-active), que viola a Content Security
    | Policy da aplicação (script-src 'self'). Os demais recursos do Boost
    | (MCP, guidelines, skills) permanecem ativos.
    |
    */
